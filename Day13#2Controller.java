...
public class HelloController {
    ...
    public ResponseEntity<?> updateBook(@PathVariable Long id, @RequestBody Book book) //This method will return a ResponseEntity with some type, but I’m not committing to what type exactly(?)
    {
        try{
   ...
   public List<Book> searchBook(@RequestParam(required = false) String title, @RequestParam(required = false) String author)//required = false makes this parameter not required when searching
   {
